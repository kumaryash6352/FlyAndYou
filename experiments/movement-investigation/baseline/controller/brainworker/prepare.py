...
def main():
    ...
    # Display real samples from the declared left/right output populations, not arbitrary glowing dots.
    ...
    manifest = {
        ...
        "nodes": n,
        "edges": w.nnz,
        "sensor": "eye-level-v2 / SurfaceRetinaV1",
        "color_rule": "Unpainted surfaces are grayscale; only physical surface paint adds color. The flag has occluded 3D geometry.",
        "input_population": "Traced ol_sensory, R-prefixed type, rootSide or somaSide L/R",
        "readout_population": "visual_projection somaSide L/R; bilateral salience into declared approach/search motor interface",
        ...
        "current": "max((R-B-48)/200,0), encoded RGB8",
        "dynamics": {
            ...
            "noise": 0.0005,
            "readout_gain": 3000.0,
            "readout_bias": 0.00023,
            "explore_speed": 0.52,
            "search_steps": 35,
            "readout_retention": 0.65,
        },
        "learning": False,
        "files": {
